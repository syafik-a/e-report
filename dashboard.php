...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
    ...
    <div class="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 h-32 md:h-64 p-4">
        <a href="#" class="flex flex-col justify-center text-center w-full h-full bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-yellow-400 dark:border-yellow-500 dark:hover:bg-yellow-500">
            <h5 class="mb-2 text-xl md:text-7xl font-bold tracking-tight text-gray-900 dark:text-black">
                <?= $report_solved[0]['status'] ?>

            </h5>
            <p class="font-normal text-gray-800 text-xl">
                Laporan Selesai
            </p>
        </a>
    </div>